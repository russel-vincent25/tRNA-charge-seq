...
class QCReportGenerator:
    ...
    def generate_html_report(self, output_path=None):
        ...
        html = render_html_shell(
            title='tRNA-charge-seq QC Report',
            h1_text='tRNA-charge-seq QC Dashboard',
            accent_color='#0984e3',
            body=body,
            intro_html=f'<p>Project: <code>{self.project_dir}</code></p>',
    ...
    def _fig_to_div(self, fig):
        ...
        Thin instance wrapper around :func:`trnaseq.qc._common.fig_to_div`
    ...
    def _html_summary_table(self, summary):
        ...
        table_html = f'<table><tr>{header_cells}</tr>{"".join(rows)}</table>'
        return render_panel('Sample Summary', table_html, anchor='qc-summary')
    ...
    def _plotly_funnel(self, summary):
        ...
        return render_panel('Pipeline Funnel', self._fig_to_div(fig), anchor='qc-funnel')
    ...
    def _plotly_mapping_bar(self, summary):
        ...
        return render_panel('Mapping Rate', self._fig_to_div(fig), anchor='qc-mapping')
    ...
    def _plotly_umi_saturation(self, summary):
        ...
        return render_panel('UMI Saturation', self._fig_to_div(fig), anchor='qc-umi')
    ...
    def _plotly_fragment_bar(self, summary):
        ...
        return render_panel('Fragment Types', self._fig_to_div(fig), anchor='qc-fragments')
    ...
    def _plotly_read_length_density(self):
        ...
        return render_panel('Read Length Distribution', self._fig_to_div(fig), anchor='qc-readlen')
    ...
    def _plotly_pca(self):
        ...
        return render_panel('PCA', self._fig_to_div(fig), anchor='qc-pca')
    ...
    def _plotly_replicate_correlation(self):
        ...
        return render_panel('Replicate Correlation', self._fig_to_div(fig), anchor='qc-replicate')
